...
> **TODO (SapperSquad): pick the release version number** — the project is at `0.1.0` internally;
...
Categories: `storage`, `game-mechanics`, `adventure`. License: SapperSquad's call at publish.
