...
public record PackLayout(List<String> tabOrder, List<TabDef> customTabs, List<Pin> pins,
     ...
     */
    public record Spill(ResourceLocation item, int keepStacks) {
        ...
        public static final Codec<Spill> CODEC = RecordCodecBuilder.create(inst -> inst.group(
                ResourceLocation.CODEC.fieldOf("item").forGetter(Spill::item),
        ...
        public static final StreamCodec<RegistryFriendlyByteBuf, Spill> STREAM_CODEC = StreamCodec.composite(
                ResourceLocation.STREAM_CODEC, Spill::item,
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, PackLayout> STREAM_CODEC =
            new StreamCodec<>() {
                // NB the two plain-ByteBuf ones: STRING_UTF8 and ResourceLocation.STREAM_CODEC are
                ...
                private static final StreamCodec<io.netty.buffer.ByteBuf, List<ResourceLocation>> VOIDS =
                ...
                public PackLayout decode(RegistryFriendlyByteBuf buf) {
                    ...
                    List<ResourceLocation> voids = VOIDS.decode(buf);
     ...
     */
    public PackLayout withKeepStacks(ResourceLocation item, int keepStacks) {
    ...
    public boolean listed(ResourceLocation itemId) {
     ...
     */
    public int keepStacks(ResourceLocation itemId) {
        for (Spill s : spill) {
